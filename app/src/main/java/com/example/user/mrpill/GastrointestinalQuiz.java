...
public class GastrointestinalQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gastrointestinal_quiz);
    ...
    private void Won() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GastrointestinalQuiz.this);
        alertDialogBuilder
                .setMessage("Congratulations! You have successfully completed this level! You have unlocked 'Skin Conditions' quiz!")
                .setCancelable(false)
    ...
    private void GameOver(){
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("New Game", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), GastrointestinalQuiz.class));
                    }
                })
                .setNegativeButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void NextQuestion(int num){
        gastrointestinal_quiz.setText(question.getQuestion(num));
